...
namespace NoteTaker.Client.Navigation
{
    public class PageNavigatorImpl
    {
        ...
        public void AddLoginPage<TPage>()
            where TPage : ContentPage
        {
            _loginPage = new NavigationPage((Page)Activator.CreateInstance(typeof(TPage)));
        }
